...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    priceCurrency: Schema.Attribute.Enumeration<['COP', 'USD']> &
    ...
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    rentPeriod: Schema.Attribute.Enumeration<['mensual', 'anual', 'diario']> &
      Schema.Attribute.DefaultTo<'mensual'>;
    rentPrice: Schema.Attribute.BigInteger;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    shortDescription: Schema.Attribute.Text;
    slug: Schema.Attribute.UID<'title'>;
    status: Schema.Attribute.Enumeration<
      ['available', 'sold', 'rented', 'reserved', 'inactive']
    > &
