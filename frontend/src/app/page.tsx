...
export default function HomePage() {
  const featured = propertiesData.filter((p: any) => p.featured).slice(0, 6)
    ...
    <div>
      ...
      <section className="py-24 bg-gray-50/50">
        <div className="container-wide">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 gap-4">
            <div>
              <span className="text-brand-600 font-semibold text-sm uppercase tracking-wider">Destacadas</span>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mt-2">
                Propiedades en Santa Marta
              </h2>
      ...
      <section className="py-24 bg-white">
        <div className="container-narrow text-center mb-16">
          <span className="text-brand-600 font-semibold text-sm uppercase tracking-wider">Por qué elegirnos</span>
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mt-3">
            La mejor manera de encontrar tu hogar
          </h2>
        </div>
        <div className="container-wide">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="text-center p-8 rounded-3xl bg-gray-50/50 border border-gray-100 hover:border-brand-200 hover:shadow-lg transition-all duration-300">
        ...
        <div className="container-narrow relative z-10 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              ...
              className="inline-flex items-center justify-center bg-white/10 hover:bg-white/20 text-white font-semibold py-4 px-8 rounded-xl transition-all duration-200 backdrop-blur-sm border border-white/20"
            >
